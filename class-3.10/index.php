...
// $random_arrayData = array_slice($random_array,3); /*For normal way writing code*/
$random_arrayData = array_slice($random_array,3,null, true); /*for preserved array key*/
...
$random_arrayData2 = array_slice($random_array,-4,3, true); /*for preserved array key*/
echo "<xmp>";
